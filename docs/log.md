...
### <u> 16/07/2026 </u>
It's now time to decide the project. Initial thought, maybe like an end user scenario that replicates the function of an ecom store would be good. But thinking about this for a while, i figure narrowing the scope
...
school or whatevr. Simply because i think computers are more interesting than trying to build a dental clinic management system as one of my projects.... Anyways, so that's the final decision, a computer hardware parts/
accessories store.
...
Core functionality: 
 ...
 - view/edit cart (clearing cart functionality, removing item functionality, increasing quantitiy functionality)
 - collect customer info using most likely JOptionPane (payment flow not required for this task)
 - save completed orderes to a dedicated file for like orders
